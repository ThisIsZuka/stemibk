...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/'.$_SESSION['hoslefno'].'/',
            'upload_url' => $this->get_full_url().'/'.$_SESSION['hoslefno'].'/',
            ...
            // the redirect parameter, e.g. '/filesss/'.
