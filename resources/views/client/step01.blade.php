...
$hospital = DB::table('stemi_hospital')->where('hos_refno','=',$patient->rq_host_hos_refno)->first();
        ...
        <div class="modal fade" id="myModal-2">
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <!-- Modal body -->
              <div class="modal-body" style="margin-left: 5%;margin-right: 10%;">
                ...
                {{-- {{Form::open(['url'=>'clientmap'])}} --}}
                    ...
                    <input type="text" value="{{@$patient->rq_id}}" name="rq_id">
                    <textarea style="border-color: #007bff;" class="form-control" name="message" id="" cols="30" rows="10"></textarea>
                    <button type="submit" name="btn_bedno" class="btn as" value="bedno">
                        รับผู้ป่วยและคงสถานะการรับผู้ป่วย
                    </button><br>
                    <button type="submit" name="btn_toolno" class="btn as" value="toolno">
                        รับผู้ป่วย และเปิดสถานะการรับผู้ป่วย
                    </button><br>
...
<div class="col-12">
    <div class="row" style="height: 500px;">
        ...
        <div id="showDD" style="margin:auto;padding-top:5px;width:550px;">
            ...
            <div id="mms">
                            From:
                            <input name="namePlace" type="hidden" id="namePlace" size="60" />
                            <br />
                            To:
                            <input name="toPlace" type="hidden" id="toPlace" size="60" />
                            ...
                            From:
                            <input name="namePlaceGet" type="hidden" id="namePlaceGet" size="60" />
                            <br />
                            To:
                            <input name="toPlaceGet" type="hidden" id="toPlaceGet" size="60" /><br />
                            ระยะทางข้อความ
                            <input name="distance_text" type="hidden" id="distance_text" value="" size="17" />
                            ระยะทางตัวเลข
                            <input name="distance_value" type="hidden" id="distance_value" value="0" size="17" />
                            เมตร<br />
                            ระยะเวลาข้อความ
                            <input name="duration_text" type="hidden" id="duration_text" size="15" />
                            ระยะเวลาตัวเลข
                            <input name="duration_value" type="hidden" id="duration_value" value="0" size="17" />
                            วินาที
    ...
    <div class="row">
        <div class="col-4">
            <form method="POST" action="https://stemi-global.com/stemi2/public/clientmap">
                {{ csrf_field() }}
            {{-- {{Form::open(['url'=>'clientmap'])}} --}}
                <input type="hidden" value="{{@$_GET['rq_id']}}" name="rq_id">

                {{-- {{$_SESSION['latitude']}}{{$_SESSION['longitude']}}<br>
                {{$hospital->hos_latitude}}.{{$hospital->hos_longitude}} --}}
...
<div class="col-12">
    <button type="submit" name="btn_way" value="have" class="btn btns jjjj">&nbsp;&nbsp;&nbsp; <b>นำทาง</b> &nbsp;&nbsp;&nbsp;</button>
</div>
</form>
<div class="col-12">
    <div class="row">
