...
<body>
    ...
    {{-- NAvBar --}}
<div class="col-12" style="background-color: #007bff;padding-top: 8px;padding-bottom: 4px;" >
    <div class="row">
        <div class="col-3">
            <a href="https://stemi-global.com/stemi2/public/patient"><i class="fas fa-chevron-left" style="color:white;"></i></a>
            <font style="color:#fff;">STEMI</font>
        </div>
...
<div class="col-12" style="background-color: #4b9ef7;padding-top: 4px;padding-bottom: 4px;" >
    <div class="row">
        ...
        <div class="col-8" style="text-align: right;">
            ...
            &nbsp;
            <a href="https://stemi-global.com/stemi2/public/chat#last"><i class="fas fa-comment ac" style="color:white;"></i></a>
        </div>
    </div>
</div>
<div class="col-12">
    <button data-toggle="modal" data-target="#myModal-2" type="button" class="btn btns">&nbsp;&nbsp;&nbsp; <b>จบงาน</b> &nbsp;&nbsp;&nbsp;</button>
</div>
</form>
<div class="col-12">
    <div class="row">
        ...
        <div class="col-6">
            ...
            <small style="color:black;font-weight: bold;">{{@$patient->pt_name}}</small><br>
            <small>ส่งจากโรงพยาบาล</small>
        </div>
        <div class="col-1">
            <small>เพศ</small><br><br>
            <small>ระยะทาง</small>
            <br>
            <input class="hid" name="distance_text" type="text" id="distance_text" value=""/>
        </div>
        <div class="col-1">
           <small>อายุ</small><br><br>
           <small>เวลา</small><br>
           <input class="hid" name="duration_text" type="text" id="duration_text"/>
        </div>
    </div>
</div>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
