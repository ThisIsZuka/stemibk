<!-- Modal -->
<div class="modal fade" id="patienttraveling10mmodal" role="dialog" style="text-align: center;">
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 mb-12">
                            <div class="txt text-modal-send">เดินทางถึงภายใน 10 นาที</div>
                        </div>
                        <div class="col-12 mb-12">
                            <div id="patienttraveling10m_patient_name" class="txt text-modal-send">ผู้ป่วย:</div>
                        </div>
                        <div class="col-12 mb-12">
                            <div id="patienttraveling10m_hospital_name" class="txt text-modal-send">ผู้ป่วยจาก:</div>
                        </div>
                    </div>
                </div>
